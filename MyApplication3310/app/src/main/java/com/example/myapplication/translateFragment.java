...
public class translateFragment extends Fragment {
    ...
    public static boolean people=true;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.btn_pet).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                people=false;
                Intent intent = new Intent(getActivity(), TranslatetalkActivity.class);
                startActivity(intent);
                //Toast.makeText(mContext,getString(R.string.btn_start),Toast.LENGTH_SHORT).show();
            }
        });
        view.findViewById(R.id.btn_people).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                people=true;
                Intent intent = new Intent(getActivity(), TranslatetalkActivity.class);
